...
from core.research.utils.json_utils import parse_json_response

from ..base_agent import BaseAgent
from ..memory.scratchpad import Plan, PlanStep, Scratchpad
from ..tool_runtime import SolveToolRuntime
from ..utils.json_utils import extract_json_from_text
from ..utils.trace import build_trace_metadata, derive_trace_metadata, new_call_id
    ...
    async def _generate_search_queries(
        ...
        try:
            ...
            async for chunk in self.stream_llm(
                ...
                parts.append(chunk)
            response = "".join(parts)
            payload = parse_json_response(response, fallback={})
    ...
    async def _aggregate_retrieval_results(
        ...
        try:
            ...
            async for chunk in self.stream_llm(
                user_prompt=user_prompt,
                system_prompt=(
                    "You are a knowledge organizer. Consolidate the provided passages "
